        ...
        return (
            <Typography>
                <Paragraph style={{fontSize: 20}}>
                    Модификатор static напрямую связан с классом, если поле статично, значит оно принадлежит классу,
                    если метод статичный, аналогично — он принадлежит классу. Исходя из этого, можно обращаться к статическому методу или полю
                    используя имя класса. Например, если поле count статично в классе <Text code>Counter</Text>, значит, вы можете обратиться
                    к переменной запросом вида: <Text code>Counter.count</Text>.
                </Paragraph>
                <Paragraph style={{fontSize: 20}}>
